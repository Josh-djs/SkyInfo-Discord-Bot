...
module.exports = {
    name: "slayer",
    description: "does all the slayer commands, with the use of arguments",
    execute(msg, args) {
        switch (args[1]) {
            case 'tara':
            case 'tarantula':
                switch (args[2]) {
                    ...
                    case 'rewards':
                        tarantularewards = new MessageEmbed()
                            ...
                            .setFooter('SkyInfo 2020')
                        msg.channel.send(tarantularewards)
                        break;
                }
                break;
            case 'sven':
                ...
                switch (args[2]) {
                    ...
                    case 'rewards':
                        revenantrewards = new MessageEmbed()
                            ...
                            .setFooter('SkyInfo 2020')
                        msg.channel.send(revenantrewards)
                        break;
                }
                break;
        }
